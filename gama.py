...
alfa=np.linspace(0.1,1.0)

# alfa_exp=np.array([0.95,0.90,0.85,0.80,0.70,0.60])

# print(alfa_exp)

plt.plot(alfa,gama(alfa,0.9),label="$\epsilon =0.9 $")

plt.plot(alfa,gama(alfa,0.7),label="$\epsilon =0.7 $")
plt.plot(alfa,gama(alfa,0.5),label="$\epsilon =0.5 $")
plt.plot(alfa,gama(alfa,0.2),label="$\epsilon =0.2 $")
...
plt.ylabel ( r' $\gamma$  ',rotation=0.0,fontsize=30)
plt.xticks(fontsize=20)
plt.yticks(fontsize=20)
plt.legend(loc=0,fontsize=20)
plt.title ( r' \textbf {Ratio de temperaturas en el estado estacionario}  ',fontsize=40)
plt.show()